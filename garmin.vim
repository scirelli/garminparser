...
silent only
cd ~\My_Programs\MyPrograms\Webdesign\htdocs\garmin
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +12 index.php
badd +25 .\css\main.css
badd +1 Notes.txt
badd +1 .\lib\getDirFiles.php
badd +1 rightbelow
badd +1 .\lib\GarminConverter.php
badd +1 .\lib\GPSVisualizerFileDownload.php
badd +58 .\setup.php
badd +1 .\lib\TCXFileSplitter.php
badd +48 .\lib\fileZipper.php
badd +1 .\act\act_fileupload.php
badd +1 .\ready.php
badd +0 .\js\main.js
badd +0 .\php\RemoveDups.php
args index.php
edit .\lib\fileZipper.php
...
exe 'vert 1resize ' . ((&columns * 10 + 85) / 170)
exe 'vert 2resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 3resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 4resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 5resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 6resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 7resize ' . ((&columns * 1 + 85) / 170)
exe '8resize ' . ((&lines * 1 + 20) / 40)
exe 'vert 8resize ' . ((&columns * 114 + 85) / 170)
exe '9resize ' . ((&lines * 7 + 20) / 40)
exe 'vert 9resize ' . ((&columns * 114 + 85) / 170)
exe '10resize ' . ((&lines * 28 + 20) / 40)
exe 'vert 10resize ' . ((&columns * 112 + 85) / 170)
exe '11resize ' . ((&lines * 28 + 20) / 40)
exe 'vert 11resize ' . ((&columns * 1 + 85) / 170)
exe 'vert 12resize ' . ((&columns * 10 + 85) / 170)
exe 'vert 13resize ' . ((&columns * 21 + 85) / 170)
argglobal
...
normal! zt
19
let s:c = 18 - ((2 * winwidth(0) + 5) / 10)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (18 - s:c) . 'l'
else
  normal! 018l
endif
wincmd w
argglobal
edit .\lib\getDirFiles.php
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
nnoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
...
normal! zt
11
let s:c = 8 - ((3 * winwidth(0) + 0) / 1)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (8 - s:c) . 'l'
else
  normal! 08l
endif
wincmd w
...
wincmd w
argglobal
edit .\lib\GPSVisualizerFileDownload.php
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
nnoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
...
64
normal zo
let s:l = 59 - ((12 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
let s:c = 27 - ((0 * winwidth(0) + 0) / 1)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (27 - s:c) . 'l'
else
  normal! 027l
endif
wincmd w
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((6 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
...
6
normal zc
let s:l = 126 - ((37 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
126
...
134
normal zc
let s:l = 107 - ((9 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 65 - ((23 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
144
normal zo
let s:l = 23 - ((3 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
let s:c = 19 - ((3 * winwidth(0) + 5) / 10)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (19 - s:c) . 'l'
else
  normal! 019l
endif
wincmd w
